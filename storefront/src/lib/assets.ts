 ...
 *
 * Pour tout changer sur le site : remplace juste ce chemin (ou dépose ton
 * fichier dans `storefront/public/redline26/` et pointe-le ici).
 */
export const PRODUCT_PHOTO = "/redline26/product-photo.jpg";
